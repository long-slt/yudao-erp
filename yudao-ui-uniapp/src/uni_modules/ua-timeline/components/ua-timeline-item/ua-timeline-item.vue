...
<template>
  <li class="ve__timeline-item" :class="[preClass]">
    ...
    <div
      ...
      :style="{ top: addUnit(Int(size) / 2 - 9) }"
    >
      <div
        v-if="!isTrue(hideTimestamp) && placement == 'top'"
        class="ve__timeline-item__timestamp is-top"
      >
        {{ timestamp }}
      </div>
      ...
      <div
        v-if="!isTrue(hideTimestamp) && placement == 'bottom'"
        class="ve__timeline-item__timestamp is-bottom"
      >
        {{ timestamp }}
      </div>
    </div>
